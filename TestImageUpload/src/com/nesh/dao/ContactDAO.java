...
public class ContactDAO {
	private static final Logger mLogger = Logger.getLogger(ContactDAO.class.getName());
	...
	public HashMap<String,Object> createContactFB(String firstName, String lastName, String email,String facebookId,String profileImageLink) {
		...
		try{
	        ...
	        Query getContactJDO= pm.newQuery(ContactJDO.class, "accessToken == '" +facebookId+ "'");
	 	    ...
	 	    if(listContactJDO.size() > 0){
	 	    	...
	 	    	contact.setAccessToken(facebookId);
	...
	public HashMap<String, Object> getAllcontact(HttpServletRequest request,HttpServletResponse response) {
		HashMap<String ,Object> resultMap = new   HashMap<String,Object> ();
		...
		try{
	        ...
	        Query getContactJDO= pm.newQuery(ContactJDO.class);
	 	    System.out.println("query " + getContactJDO);
	 	    List<ContactJDO> listContactJDO = (List<ContactJDO>) getContactJDO .execute();
	 	    
	 	    for(int contactIndex = 0 ;contactIndex< listContactJDO.size();contactIndex ++){
	 	    	resultMap.put(listContactJDO.get(contactIndex).getUserId(), listContactJDO.get(contactIndex));
