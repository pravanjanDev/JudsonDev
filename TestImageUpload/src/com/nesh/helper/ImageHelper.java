...
public class ImageHelper {
	...
	public HashMap<String, Object> getRejectedImageWithRequestPagination(HttpServletRequest request, HttpServletResponse response) {
			...
			HashMap<String,Object> imageMap = imageDAO.getAllRejectedImage(request, response);
			return imageMap ;
	...
	public void rejectImageStatus(HttpServletRequest request,HttpServletResponse response) {
		try{
			 imageDAO.rejectImageStatus(request, response);
	...
	public void deleteImageStatus(HttpServletRequest request,HttpServletResponse response) {
		try{
			 imageDAO.deleteImageStatus(request, response);
	...
	public LinkedHashMap<String, Object> getApproveImageWithRequestSortingOrder(HttpServletRequest request, HttpServletResponse response) { 
		LinkedHashMap<String,Object> imageMap = (LinkedHashMap<String, Object>) imageDAO.getApproveImageWithRequestSortingOrder(request, response);
			return imageMap ;
	}
