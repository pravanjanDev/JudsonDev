...
public class ContactDAO {
	...
	public HashMap<String,String> getContact(String email,String password) {
		...
		try{
	        ...
	        Query getContactJDO= pm.newQuery(ContactJDO.class, " userEmail == '" +email+ "' and userPassword='"+password+"'");
	 	    System.out.println("query " + getContactJDO);
	 	    List<ContactJDO> listContactJDO = (List<ContactJDO>) getContactJDO .execute();
	 	    if(listContactJDO.size() > 0){
	 	    	...
	 	    	resultMap.put("Response","We have not found your mailid ");
