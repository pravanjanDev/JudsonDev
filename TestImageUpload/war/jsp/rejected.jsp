	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="dashboard.jsp" class="active-tab dashboard-tab">Pending</a></li>
				<li><a href="rejected.jsp" id="back-tab" class="active-tab dashboard-tab">Rejected</a></li>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fi">REJECTED IMAGES</h3>
